...
import time
import gym
from optuna.integration import TPEPruner
...
from MyAgent.Agent import PPOAgent as MyRDDLAgent
...
if __name__ == "__main__":
    ...
    study = create_study(direction="maximize", pruner=TPEPruner())
    study.optimize(lambda trial: main(env, inst, method
